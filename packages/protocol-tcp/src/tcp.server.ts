...
type ServerEventHandlers<T extends ServerHandlerType> = T extends "connection"
	? SocketHandler
	: T extends "message"
...
export class TcpServer {
	...
	on<T extends ServerHandlerType>(event: T, handler: ServerEventHandlers<T>): void {
		switch (event) {
			case "connection":
				this.onConnection = handler as SocketHandler;
				break;
			case "message":
				this.onMessage = handler as ServerMessageHandler;
				break;
			case "error":
				this.onError = handler as ServerErrorHandler;
				break;
			case "close":
				this.onClose = handler as ServerCloseHandler;
				break;
			case "disconnect":
				this.onDisconnect = handler as DisconnectHandler;
				break;
		}
	}
